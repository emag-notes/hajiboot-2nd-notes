...
public class HajibootRestApplicationTests {
  ...
  public void testGetCustomers() throws Exception {
    ResponseEntity<Page<Customer>> response = getCustomers();
  ...
  public void testPostCustomers() throws Exception {
    ...
    assertThat(getCustomers().getBody().getNumberOfElements()).isEqualTo(3);
  }
  ...
  public void testDeleteCustomers() throws Exception {
    ...
    assertThat(getCustomers().getBody().getNumberOfElements()).isEqualTo(1);
  }
