...
public class CustomerRepository {
  ...
  private static final RowMapper<Customer> customerRowMapper = (rs, i) -> new Customer(
    rs.getInt("id"),
  ...
  public Customer findOne(Integer customerId) {
    ...
    return jdbcTemplate.queryForObject("SELECT id, first_name, last_name FROM customers ORDER BY id", param, customerRowMapper);
  }
